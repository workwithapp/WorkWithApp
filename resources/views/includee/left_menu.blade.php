		...
		<div class="sidebar-shortcuts-large" id="sidebar-shortcuts-large">
			...
			<ul class="nav nav-list">
				...
				<li class="">
						...
						<ul class="submenu">
							<li class="">
								<a href="<?php echo url('/');?>/admin/get_users">
            	...
            	<li class="">
					...
					<ul class="submenu">
							<li class="">
								<a href="<?php echo url('/');?>/admin/add_services">
									<i class="menu-icon fa fa-caret-right"></i>
									Add Services
								</a>
								<b class="arrow"></b>
  	          ...
  	          <!--  <li class="">
						<a href="<?php echo url('/');?>/admin/report_management">
							...
							<span class="menu-text"><small>Report management</small> </span>
						</a>
						<b class="arrow"></b>
				</li> -->
	            ...
	            <li class="">
					...
					<ul class="submenu">
							<li class="">
								<a href="<?php echo url('/');?>/admin/view_payment_transactions">
									<i class="menu-icon fa fa-caret-right"></i>
